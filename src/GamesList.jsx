...
import Slobberhannes from './games/Slobberhannes.jsx';
...
class GamesList extends React.Component {
    ...
    getDatasetsDividedByIndices() {
        ...
        data.sort(function (a, b) {
            return context.getNameIndex(a.state.name) + a.state.name > context.getNameIndex(b.state.name) + b.state.name ? 1: -1;
        });
